...
%\large
	\section{Problem Set}
		\begin{enumerate}	
			...
			Data ini berasal dari angket yang diisi oleh anda dan peserta kelas tahun lalu. Jika tidak disebutkan, berarti gunakan \textit{dataset} gabungan!
				...
				\begin{enumerate}
					\item Buatlah diagram batang yang menunjukkan jumlah respons dari masing-masing kelas (2017 dan 2018)!
					\item Jika diketahui pada tahun 2017 ada 31 orang peserta kelas, dan pada tahun 2018 ada 18 orang peserta, buatlah \textit{pie chart} yang menunjukkan persentase jumlah mahasiswa yang mengisi angket untuk masing-masing kelas!
					...
					\item Buatlah tabel distribusi frekuensi serta diagram batang untuk kelompok jenis kelamin.
						\begin{enumerate}
							...
							\item Per-angkatan, dalam 1 grafik
						\end{enumerate}
					\item Dari data tanggal lahir yang ada, hitunglah umur (per tanggal 1 November 2018) setiap mahasiswa yang mengisi angket tersebut. Kemudian buatlah histogram untuk data umur mahasiswa.
					\item Kelompokkan data umur mahasiswa berdasarkan peserta 2017 dan 2018, dan buatlah histogram untuk keduanya. Histogram berada dalam 1 grafik 
					...
					\item Buatlah \textit{pie chart} untuk persentase pilihan bidang riset:
						...
						\end{enumerate}
					\item Tentukan apakah: IPK peserta kelas 2017 dan 2018 relatif sama.
	...
	\section{Aturan Pengerjaan}
		\begin{enumerate}
			\item Laporan dikumpulkan pada kuliah hari Senin tanggal 5 November 2018. Masing-masing kelompok cukup mengumpulkan satu buah laporan.
